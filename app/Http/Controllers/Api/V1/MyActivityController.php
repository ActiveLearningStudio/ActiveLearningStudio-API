...
use App\Http\Resources\V1\MyActivityResource;
 ...
 * @group 5. MyActivity
 *
 * APIs for my activity management
 */
class MyActivityController extends Controller
{
    ...
    /**
     * MyActivityController constructor.
     *
    ...
    public function index(Request $request)
    {
        ...
        return  MyActivityResource::collection($this->activityRepository->myActivities($request->all(), $auth_user));
    }
