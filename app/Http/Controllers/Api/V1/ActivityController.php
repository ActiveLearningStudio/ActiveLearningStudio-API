...
class ActivityController extends Controller
{
    ...
    public function clone(Request $request, Playlist $playlist, Activity $activity)
    {
        ...
        return response([
            "message" => "Your request to $process  activity [$activity->title] has been received and is being processed. Check notifications at the top page, A new message will be delivered when it is ready.",
        ], 200);
    }
