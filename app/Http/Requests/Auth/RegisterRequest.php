...
class RegisterRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'email' => 'required|email|max:255|unique:users,email,NULL,id,deleted_at,NULL|exists:invited_organization_users,invited_email', // pass the email if record is soft-deleted issue#CUR-537
