 ...
 * class          StoreKalturaAPISetting  
 */
namespace App\Http\Requests\V1\Integration;

use Illuminate\Foundation\Http\FormRequest;

class StoreKalturaAPISetting extends FormRequest
{
    /**
    ...
    {
        return [
            'partner_id' => 'required|string|max:50|unique:kaltura_api_settings,partner_id,NULL,id,deleted_at,NULL',
            'sub_partner_id' => 'nullable|string|max:50|unique:kaltura_api_settings,sub_partner_id,NULL,id,deleted_at,NULL',
            'name' => 'nullable|string|max:100|unique:kaltura_api_settings,name,NULL,id,deleted_at,NULL',
            'email' => 'nullable|string|max:150|unique:kaltura_api_settings,email,NULL,id,deleted_at,NULL',
            'expiry' => 'nullable|string|max:150',
            'session_type' => 'nullable|integer|max:2',
            'admin_secret' => 'required|string|max:255|unique:kaltura_api_settings,admin_secret,NULL,id,deleted_at,NULL',
            'user_secret' => 'nullable|string|max:255|unique:kaltura_api_settings,user_secret,NULL,id,deleted_at,NULL',
