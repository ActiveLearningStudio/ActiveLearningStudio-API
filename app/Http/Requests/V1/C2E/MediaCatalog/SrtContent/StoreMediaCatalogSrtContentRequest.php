...
/**
 * @author        Asim Sarwar
 * Description    Validation request class for create media catalog srt contents
 * class          StoreMediaCatalogSrtContentRequest  
 */
class StoreMediaCatalogSrtContentRequest extends FormRequest
{
    /**
