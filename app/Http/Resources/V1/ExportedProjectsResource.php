...
class ExportedProjectsResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'will_expire_on'=> Carbon::parse($this->created_at)->addDays(config('constants.default-exported-projects-days-limit'))
            ->format(config('constants.default-date-format')),
