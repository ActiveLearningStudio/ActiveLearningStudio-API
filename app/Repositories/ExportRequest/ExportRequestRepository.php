...
namespace App\Repositories\ExportRequest;
...
class ExportRequestRepository extends BaseRepository implements ExportRequestRepositoryInterface
{
    ...
    /**
     * Get Export Request By Status
     *
     * @param $status
     * @return ExportRequest $exportRequest
     */
