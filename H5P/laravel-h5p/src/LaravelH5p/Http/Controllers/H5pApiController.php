...
class H5pApiController extends Controller
{
    public function index(Request $request)
    {
        ...
        return response()->json(compact('entries', 'request', 'search_fields'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            if ($return_id) {
                ...
                return response()->json(['fail' => trans('laravel-h5p.content.can_not_updated')]);
            }
        } catch (H5PException $ex) {
            return response()->json(['fail' => trans('laravel-h5p.content.can_not_updated')]);
        }
