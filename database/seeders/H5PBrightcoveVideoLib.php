...
class H5PBrightcoveVideoLib extends Seeder
{
    ...
    public function run()
    {
        $this->removeBrightcoveSearchLibDependency();
    ...
    private function removeBrightcoveSearchLibDependency() {
        ...
        if ($h5pBrightcoveLib && $h5pBrightcoveSearchLib) {
          $h5pBCLibParams = [
            'library_id' => $h5pBrightcoveLib->id,
              'required_library_id' => $h5pBrightcoveSearchLib->id,
              'dependency_type' => 'editor'
          ];
          DB::table('h5p_libraries_libraries')->where($h5pBCLibParams)->delete();
          $h5pBrightcoveSearchLib = DB::table('h5p_libraries')->where($h5pBrightcoveSearchParams)->delete();
        }
    }

    private function bcSemantics() {
        return '[
          {
