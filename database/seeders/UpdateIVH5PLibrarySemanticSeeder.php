...
class UpdateIVH5PLibrarySemanticSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        $h5pIVLibParams = ['name' => "H5P.InteractiveVideo", "major_version" => 1, "minor_version" => 24];
        $h5pIVLib = DB::table('h5p_libraries')->where($h5pIVLibParams);
        if ($h5pIVLib) {
            DB::table('h5p_libraries')->where($h5pIVLibParams)->update([
