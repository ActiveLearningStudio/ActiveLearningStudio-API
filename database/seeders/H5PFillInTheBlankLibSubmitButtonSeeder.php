...
class H5PFillInTheBlankLibSubmitButtonSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        $h5pFillInTheBlankLibParams = ['name' => "H5P.Blanks", "major_version" => 1, "minor_version" => 12];
        $h5pFillInTheBlankLib = DB::table('h5p_libraries')->where($h5pFillInTheBlankLibParams)->first();
        if ($h5pFillInTheBlankLib) {
            DB::table('h5p_libraries')->where($h5pFillInTheBlankLibParams)->update(['semantics' => $this->updatedSemantics()]);
        }
    }
