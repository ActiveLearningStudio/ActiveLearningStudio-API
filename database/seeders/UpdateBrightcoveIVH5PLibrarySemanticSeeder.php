...
class UpdateBrightcoveIVH5PLibrarySemanticSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        $h5pBrightcoveIVLibParams = ['name' => "H5P.BrightcoveInteractiveVideo", "major_version" => 1, "minor_version" => 1];
        $h5pBrightcoveIVLib = DB::table('h5p_libraries')->where($h5pBrightcoveIVLibParams);
        if ($h5pBrightcoveIVLib) {
            DB::table('h5p_libraries')->where($h5pBrightcoveIVLibParams)->update([
