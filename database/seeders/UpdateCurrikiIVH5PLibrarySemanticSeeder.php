...
class UpdateCurrikiIVH5PLibrarySemanticSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        $h5pCurrikiIVLibParams = ['name' => "H5P.CurrikiInteractiveVideo", "major_version" => 1, "minor_version" => 1];
        $h5pCurrikiIVLib = DB::table('h5p_libraries')->where($h5pCurrikiIVLibParams);
        if ($h5pCurrikiIVLib) {
            DB::table('h5p_libraries')->where($h5pCurrikiIVLibParams)->update([
