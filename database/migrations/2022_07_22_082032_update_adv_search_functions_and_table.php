...
class UpdateAdvSearchFunctionsAndTable extends Migration
{
    ...
    public function up()
    {
        ...
        $advsearchSql = <<<'EOL'
        CREATE OR REPLACE FUNCTION advsearch(_text character varying, _subject character varying, _education character varying, _tag character varying)
        ...
        CREATE OR REPLACE FUNCTION advsearch(_uid integer,_text character varying, _subject character varying, _education character varying, _tag character varying)
        RETURNS SETOF advsearch_dtnew
        LANGUAGE plpgsql
        AS $function$
        declare 
