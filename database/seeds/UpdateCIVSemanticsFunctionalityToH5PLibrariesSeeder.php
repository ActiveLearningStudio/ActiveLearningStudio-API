...
class UpdateCIVSemanticsFunctionalityToH5PLibrariesSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
	    $h5pCIVLibParams = ['name' => 'H5P.CurrikiInteractiveVideo', 'major_version' => 1, 'minor_version' => 0];
        $h5pCIVLib = DB::table('h5p_libraries')->where($h5pCIVLibParams)->first();
        if ($h5pCIVLib) {
            DB::table('h5p_libraries')->where($h5pCIVLibParams)->update([
