...
class H5PBrightcoveVideoLib extends Seeder
{
    /**
    ...
    public function run()
    {
        $this->setupBrightcoveSearchLib();
        $this->addBrightcoveSearchLibDependency();
        
        $h5pBrightcoveLibParams = ['name' => "H5P.BrightcoveInteractiveVideo", "major_version" => 1, "minor_version" => 0];
        $h5pBrightcoveLib = DB::table('h5p_libraries')->where($h5pBrightcoveLibParams)->first();
        if ($h5pBrightcoveLib) {
            DB::table('h5p_libraries')->where($h5pBrightcoveLibParams)->update(['semantics' => $this->bcSemantics()]);
        }
    }
    
    public function setupBrightcoveSearchLib() {
        $h5pBrightcoveSearchParams = ['name' => "H5PEditor.BrightcoveSearch", "major_version" => 1, "minor_version" => 0];
        $h5pBrightcoveSearchLib = DB::table('h5p_libraries')->where($h5pBrightcoveSearchParams)->first();
        if (!$h5pBrightcoveSearchLib) {
                DB::table('h5p_libraries')->insert([
                    'name' => "H5PEditor.BrightcoveSearch", 
                    'title' => "Brightcove Search", 
                    "major_version" => 1, 
                    "minor_version" => 0,
                    "patch_version" => 0,
                    "runnable" => 0,
                    ...
                    "fullscreen" => 0,
                    "embed_types" => '',
                    "preloaded_js" => 'scripts/brightcove-search.js, scripts/config.js',
                    "preloaded_css" => 'styles/brightcove-search.css',
                    "drop_library_css" => '',
                    "drop_library_css" => '',
                    "semantics" => '',
                    "tutorial_url" => '',
    ...
    public function addBrightcoveSearchLibDependency() {
        $h5pBrightcoveParams = ['name' => "H5P.BrightcoveInteractiveVideo", "major_version" => 1, "minor_version" => 0];
        $h5pBrightcoveLib = DB::table('h5p_libraries')->where($h5pBrightcoveParams)->first();
        
        $h5pBrightcoveSearchParams = ['name' => "H5PEditor.BrightcoveSearch", "major_version" => 1, "minor_version" => 0];
        $h5pBrightcoveSearchLib = DB::table('h5p_libraries')->where($h5pBrightcoveSearchParams)->first();
        
        $h5pBCLibParams = [
            'library_id' => $h5pBrightcoveLib->id,
            'required_library_id' => $h5pBrightcoveSearchLib->id,
            'dependency_type' => 'editor'
        ];

        $h5pBrightcoveDep = DB::table('h5p_libraries_libraries')->where($h5pBCLibParams)->first();

        if ($h5pBrightcoveLib && $h5pBrightcoveSearchLib && !$h5pBrightcoveDep) {
            DB::table('h5p_libraries_libraries')->insert($h5pBCLibParams);
        }
    }

    public function bcSemantics() {
        return '[
            {
