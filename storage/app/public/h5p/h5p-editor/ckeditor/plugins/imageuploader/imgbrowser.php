...
<head>
    ...
    <title><?php echo $imagebrowser1; ?> ::Curriki Stuido</title>
...
<?php if($file_style == "block") { ?>
    <div class="fileDiv">
        ...
        <p class="fileDescription">&copy; 2020 by AHMAD MUKHTAR</p>
        <p class="fileTime">currikistudio.org</p>
...
<?php } elseif($file_style == "list") { ?>
    <div class="fullWidthFileDiv">
        ...
        <p class="fullWidthfileTime fullWidth30percent">currikistudio.org</p>
    </div>
<?php } ?>
