 ...
 * DisplayName.enUS: ActiveLearningStudio-API/target/classes/application.properties
 * Map.hackathonLabel: create_java_class_Target_classes_application
 * Map.hackathonMission: Create the file ActiveLearningStudio-API/target/classes/application.properties
 ...
 */
public class Target_classes_application {

	/**
	 * DisplayName.enUS: Define the JDBC Database properties. 
	 * enUS: Create a new file: /usr/local/src/ActiveLearningStudio-API/target/classes/application.properties
	 * enUS: 
	 * enUS: 
	 */
	public void part1() {
